...
$compilerArgs = @('/nologo', '/std:c++17', '/utf-8', '/EHsc', '/W4', '/WX', '/MD',
  ...
  "$PSScriptRoot/game_state_test.cpp", "$PSScriptRoot/battle_test.cpp", '/link', "/LIBPATH:$msvc/lib/x64",
...
foreach ($relative in @('src/game/game_app.cpp', 'src/game/game_app.h', 'src/game/game_state.h',
    'src/game/type.h', 'src/game/move.h', 'src/game/battle.h', 'src/game/pokemon.h', 'src/game/save_data.h', 'src/game/save_storage.h', 'src/game/exploration.h', 'src/game/encounter.h', 'src/core/app_config.h',
