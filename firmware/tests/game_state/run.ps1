...
$compilerArgs = @('/nologo', '/std:c++17', '/utf-8', '/EHsc', '/W4', '/WX', '/MD',
  ...
  "$game/pokemon.cpp", "$game/pokemon_record_codec.cpp", "$game/game_state.cpp", "$game/save_data.cpp", "$game/save_storage.cpp", "$game/capture_storage.cpp", "$game/box_data.cpp", "$game/box_storage.cpp",
  "$game/exploration.cpp", "$game/encounter.cpp", "$game/type.cpp", "$game/move.cpp", "$game/battle.cpp",
  "$PSScriptRoot/game_state_test.cpp", "$PSScriptRoot/save_wire_test.cpp", "$PSScriptRoot/save_pair_test.cpp", "$PSScriptRoot/capture_storage_test.cpp", "$PSScriptRoot/battle_test.cpp", '/link', "/LIBPATH:$msvc/lib/x64",
...
foreach ($relative in @('src/game/game_app.cpp', 'src/game/game_app.h', 'src/game/game_state.h',
    'src/game/capture_storage.h', 'src/game/box_storage.h', 'src/game/box_data.h', 'src/game/pokemon_record_codec.h', 'src/game/type.h', 'src/game/move.h', 'src/game/battle.h', 'src/game/pokemon.h', 'src/game/save_data.h', 'src/game/save_storage.h', 'src/game/exploration.h', 'src/game/encounter.h', 'src/core/app_config.h',
